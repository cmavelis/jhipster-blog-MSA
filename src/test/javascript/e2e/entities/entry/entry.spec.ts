...
describe('Entry e2e test', () => {
  ...
  it('should load create Entry page', async () => {
    ...
    expect(await entryUpdatePage.getPageTitle().getText()).to.match(/Create or edit a Entry/);
  ...
  it('should delete last Entry', async () => {
    ...
    expect(await entryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/blogApp.entry.delete.question/);
